    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute top-4 right-4 rounded-lg opacity-70 outline-none transition-opacity hover:opacity-100 focus-visible:ring-3 focus-visible:ring-ring/50"
        >
